...
We introduce a macro to look up these paths safely at compile time.
...
html! {
    <img src="/static/logo.8f3a21.png" />
}
```

**Why a macro?**

-   **Compile-time Check**: If `/img/logo.png` doesn't exist, the build fails. No more broken images in production!
-   **Zero Runtime Cost**: The lookup happens during compilation.
