...
## 🚀 v15.13.0 Release Notes

**Azumi v15.13.0** — Production-ready with TrustedHtml Component, improved safety, and comprehensive test fixes.
...
```toml
azumi = { version = "15.12.17", default-features = false }
```
