...
## 🚀 v15.17.0 Release Notes

**Azumi v15.17.0** — Clean release with consolidated documentation and removed magic transformations.
...
```toml
azumi = { version = "15.17.0", default-features = false }
```
